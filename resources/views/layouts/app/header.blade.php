    ...
    <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        @guest
            <flux:navbar class="me-1.5 space-x-0.5 rtl:space-x-reverse py-0!">
                ...
                <flux:navbar.item class="h-10" href="{{ route('login') }}">{{ __('Login') }}</flux:navbar.item>
                <flux:navbar.item class="h-10" href="{{ route('register') }}">{{ __('Register') }}</flux:navbar.item>
            </flux:navbar>
        @else
            <!-- Desktop User  -->
            <flux:dropdown position="top" align="end">
                ...
                <flux:menu>
                    ...
                    @if (auth()->user()->role === 'admin')
                        <flux:menu.radio.group>
                            <flux:menu.item :href="route('filament.admin.pages.dashboard')" icon="shield-check" wire:navigate>
                                {{ __('Dashboard') }}
                            </flux:menu.item>
                        </flux:menu.radio.group>
                    @endif
                    ...
                    <flux:menu.radio.group>
                        <flux:menu.item :href="route('courses.my')" icon="academic-cap" wire:navigate>{{ __('My Courses') }}
                        </flux:menu.item>
                    </flux:menu.radio.group>
                    <flux:menu.separator />
    ...
    <flux:sidebar stashable sticky
        ...
        @guest
            ...
            <flux:navlist variant="outline">
                ...
                <flux:navlist.item href="register">
                    {{ __('Register') }}
                </flux:navlist.item>
            </flux:navlist>
        @endguest
